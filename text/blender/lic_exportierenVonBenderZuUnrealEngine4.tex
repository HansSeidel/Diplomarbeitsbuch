...
Export > FBX (.fbx)} aus und wählt dann in den Exporteinstellungen unter Main den Punkt \menu{Selected Objects} aus. Um Smooth Shading (Kapitel \ref{objectMode:smoothshading})
