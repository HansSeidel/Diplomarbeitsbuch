...
Export > FBX (.fbx)} aus und wählt dann in den Exporteinstellungen unter Main den Punkt \menu{Selected Objects} aus. Um Smooth Shading (\textit{Kapitel \ref{objectMode:smoothshading} \dq Smooth Shading\dq})
auch zu exportieren, muss man unter \menu{Geometrie} im Punkt \menu{Smoothing} den Wert \menu{Face} angeben. Jetzt kann man die Datei mit \menu{Export FBX} exportieren.
