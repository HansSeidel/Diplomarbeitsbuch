...
(Kapitel \ref{sec:sculpting} - \textit{DynTopo}).
...
die Details hinzugefügt: Narben, Gesichtsfalten, Hautirritationen, Beulen, etc. (Siehe Abbildung\ref{picture:antagonist_process})
...
Diese Methode löscht Kanten, die das Modell unkreisen. Es ist der gegenteilige Prozess von Loop-Cuts (Siehe Kapitel \ref{sec:subdivision}).
