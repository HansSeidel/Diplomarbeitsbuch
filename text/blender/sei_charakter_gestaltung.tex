...
\begin{longtable}{|p{3.6cm}|p{3.6cm}|p{6.4cm}|}
    ...
    \hline
    \caption{Die verschiedenen Pinsel des Blender Scupting Tools}
...
Standard-Mäßig wird der Loop-Cut in der Mitte des Objektes gesetzt. Durch die Tastenkombination \keys{STRG+R},
...
Um einen Charakter zu Texturieren, muss man diesen als erstes \texit{unwrappen}. Unwrappen bedeutet, dass man die Flächen
eines Objektes aufklappt und zweidimensional darstellt. Blender bietet mehrere Möglichkeiten an, ein Objekt zu
\texit{unwrappen}. Die meist verwendeten sind "Smart UV-Projekt"\citep{blender:smart_uv} und
