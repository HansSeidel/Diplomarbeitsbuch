...
aber notwendig, damit nachher noch eine andere Textur mit einer eigenen Bumpmap\todo{Referenz bei Hans} verwendet werden kann. Um das Gesicht zu erstellen wurde zuerst auf einer Seite der Säule,
...
möglich entfernt worden, ohne dass das Aussehen der Statue stark beeinträchtigt wurde.\todo{Proofreading}
...
Wenn die Form passend ist pausiert man die Simulation. Dadurch, das die Decke animiert wurde, ist sie kein Objekt mehr.
Deshalb muss man sie am Schluss noch in ein Objekt umformen, damit man die Decke frei bewegen kann, ohne das sie in die Form vor der Simulation zurückspringt.
\todo{Proofreading}
