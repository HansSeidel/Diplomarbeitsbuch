...
\begin{figure}[H]
    \centering
    \includegraphics[width=.4\textwidth]{images/Paracelsus-Grab_Nachmodellierung.png}
...
Nach dem Erstellen der Bezier-Curves, wurden diese zu einem Mesh\footnote{Ein Mesh entspricht einem Modell} konvertiert, damit sie anschließend mittels Boolean-Modifikator mit der Vase verbunden
