...
Ein großer Teil im für die Spielentwicklung, war das Modellieren. In diesem Kapitel wird gezeigt, wie man kompliziertere
...
drücken. Im Menü sieht man dann das Feld \menu{Background Images} (\textit{Abbildung \ref{Paracelsus_Grab:image1}}). Dort kann man dann den Pfad des Bildes angeben
