...
\todo{Alle "Kapitel" gleich referenzieren. z.B. Kapitel 1 Kapitelname}
...
\todo{Bei Mausoleum und Cutscene wurde das auch gemacht adden.}
...
Das Hauptgrab, ist einem echten Grab was unser Team auf einem Friedhof gesehen hat nachempfunden. Der Grabsockel besteht aus einem angepassten Würfel
mit einem Bevel Modifikator. Der Grabdeckel wurde mit ebenfalls aus einem Würfel modelliert und anschließend mit einem Bevel Modifikator so bearbeitet, dass
er seine Einkerbungen bekommen hat. Der Griff ist, ein mit einem Boolean Modifikator zusammengefügter Würfel und Torus.
Der Griff wurde mittel Array Modifikator vervielfältigt und im passenden Winkel am Grabdeckel angebracht. Mit \keys{\ctrl + J} wurden beide Objekte zusammengefügt.
...
Verwendete Modifikatoren: Kapitel \ref{Bevel:heading} Bevel \verb+;+ Kapitel \ref{Boolean:heading} Boolean \verb+;+ Kapitel \ref{Array:heading} Array
...
wurde sie mit \keys{\Alt + C} zu einem Mesh konvertiert, damit sie dann mit der Vase, mittels Boolean Modifikator verbunden
...
Verwendete Modifikatoren: Kapitel \ref{Decimate:heading} Decimate
\begin{figure}[H]
    \centering
...
Verwendete Modifikatoren: Kapitel \ref{Boolean:heading} Boolean
...
in den Physics Tab wechseln und \menu{Cloth} auswählen. Jetzt verhält sich die Decke wie ein Stoffstück. Wenn man nun auf der Timeline auf Play drückt, bewegt sich die Bettdecke und verformt sich.
