\section{Object Mode}
Der Object Mode in Blender ist dazu da,\todo{Beistrich?} um ein ganzes 3D-Objekt zu verändern. Man kann es beispielsweise im Koordinatensystem ausrichten, aber
...
es rund aussehen zu lassen. Man kann also sehr gut die Performance des Spiels verbessern,\todo{Beistrich weg und nach wenn man?} wenn man anstatt einer hohen Anzahl an Flächen, Smooth Shading verwendet.
...
Die Standardansicht eines Objektes ist im Global View. Man sieht das ausgewählte Objekt und alle anderen Objekte in derselben Ebene,\todo{Beistrich?} die nicht ausgeblendet sind.
