...
und mit \keys{\shift + S} \menu{Cursor to Selected} den Cursor setzt und anschließend im Object Mode mit \keys{\ctrl + \shift + \Alt + C}
\menu{Origin to 3D Cursor} den Origin setzt.
