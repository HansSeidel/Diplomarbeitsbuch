...
drei Boolean-Operationen,\todo{Beistrich?} die man anwenden kann.\citep{blender:boolean_modifier}
...
Grundobjekt,\todo{Beistrich?} welches gespiegelt wird.
...
Der Bevel Modifikator wurde oft verwendet,\todo{Beistrich?} damit die erstellten Objekte echt aussehen, weil jedes Objekt z.B. eine Tischkante nie abrupt
...
\subsection{Decimate-Modifikator}
...
Mit dem Edge Split Modifikator kann man bei einem Objekt bestimmen,\todo{Beistrich?} ab welchem Winkel Smooth Shading angewendet wird.\citep{blender:edgesplit_modifier}
