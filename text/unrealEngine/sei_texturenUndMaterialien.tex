...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{SEI_Texturierung_Texturen_in_der_Engine-MaterialOutput.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{SEI_Texturierung_Texturen_in_der_Engine-InputMoeglichkeit.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{SEI_Texturierung_Texturen_in_der_Engine-Property-Map.png}
