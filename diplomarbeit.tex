...
\chapter*{Vorwort}
\input{text/00_vorlage/00_vorwort.tex}

\chapter*{Kurzfassung}
\input{text/00_vorlage/00_kurzfassung.tex}

\chapter*{Abstract}
\selectlanguage{english}
\input{text/00_vorlage/00_abstract.tex}
...
\chapter{Ziele}
Die Aufgabe die sich das Diplomarbeitsteam gesetzt hat war es, sich ein umfangreiches Wissen in dem
...
%\input{text/planung/c_planung.tex}
%Kapitel einfügen
%Ende des Kapitel
...
\input{text/blender/c_blender.tex}
%Kapitel einfügen
%Ende des Kapitel
...
\input{text/unrealEngine/c_unrealEngine.tex}
%Kapitel einfügen
%Ende des Kapitel
\chapter{Sound}
...
\input{text/website/c_website.tex}
%Kapitel einfügen
%Ende des Kapitel
